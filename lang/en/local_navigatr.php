...
$string['decryption_failed'] = 'Token decryption failed. Please reconfigure your Personal Access Token.';
$string['duplicate_badge_prevented'] = 'Duplicate badge issuance prevented';
$string['encryption_failed'] = 'Token encryption failed. Please try again.';
...
$string['error_auth_failed'] = 'Authentication failed. Please check your Personal Access Token.';
$string['error_invalid_credentials'] = 'Invalid token (HTTP 401). Verify your Personal Access Token is valid and not revoked.';
...
$string['pat_unmask_warning'] = 'Token will be visible when editing. It is encrypted before storage. ' .
    '<a href="{$a}" target="_blank">Create a Personal Access Token →</a>';
$string['personal_access_token'] = 'Personal Access Token';
$string['personal_access_token_help'] = 'Enter your Navigatr Personal Access Token. ' .
    'Personal Access Tokens provide secure API access without sharing your account password. ' .
    'Tokens can be created and managed in your Navigatr account settings.';
...
$string['provider_config_notice'] = 'Please make sure a site administrator has added a Navigatr Personal Access Token ' .
...
$string['remove_connection_confirm'] = 'Are you sure you want to remove the current Navigatr connection? ' .
    'This will clear your stored Personal Access Token. ' .
...
$string['security_note'] = 'The Personal Access Token is encrypted using AES-256-CBC encryption with site-specific keys.';
