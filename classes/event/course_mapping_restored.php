...
/**
 * Course mapping restored event class.
 *
 * @package    local_navigatr
 * @copyright  2025 Navigatr
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class course_mapping_restored extends \core\event\base {
    ...
    public function get_description() {
        ...
        return "Badge mapping restored for course {$this->courseid}. " .
               "Badge ID: {$badgeid}, Provider ID: {$providerid}, New mapping ID: {$newid}.";
    }
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['badge_id'])) {
            throw new \coding_exception('The \'badge_id\' value must be set in other.');
        }
